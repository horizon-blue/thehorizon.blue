  ...
  _createClass(MarkupGenerator, [{
    ...
    value: function renderBlockContent(block) {
      ...
      return entityPieces.map(function (_ref2) {
        ...
        var entityStyle1 = void 0;
        if (entityType != null && entityType === 'IMG' && (entityStyle1 = _this.options.entityStyleFn(entity))) {
          var _element3 = entityStyle1.element,
              _attributes4 = entityStyle1.attributes,
              _style4 = entityStyle1.style;

          var _img_link = _attributes4.src;

          if (_element3[0] == '*') {
            _img_link = _element3.substr(1);
            _element3 = 'img';
          }
          // Normalize `className` -> `class`, etc.
          _attributes4 = (0, _normalizeAttributes2.default)(_attributes4);
          if (_style4 != null) {
            var styleAttr1 = (0, _styleToCSS2.default)(_style4);
            _attributes4 = _attributes4 == null ? { style: styleAttr1 } : _extends({}, _attributes4, { style: styleAttr1 });
          }
          var attrString1 = stringifyAttrs(_attributes4);
          return '<a target="_blank" href="' + _img_link +'"><' + _element3 + attrString1 + '>' + content + '</' + _element2 + '></a>';
        } else if (entity != null && _this.options.entityStyleFn && (entityStyle = _this.options.entityStyleFn(entity))) {
